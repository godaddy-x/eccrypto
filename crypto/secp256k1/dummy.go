...
import (
	_ "github.com/godaddy-x/eccrypto/crypto/secp256k1/libsecp256k1/include"
	_ "github.com/godaddy-x/eccrypto/crypto/secp256k1/libsecp256k1/src"
	_ "github.com/godaddy-x/eccrypto/crypto/secp256k1/libsecp256k1/src/modules/recovery"
)
